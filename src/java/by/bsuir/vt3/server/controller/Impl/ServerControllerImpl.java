package java.by.bsuir.vt3.server.controller.Impl;

import java.by.bsuir.vt3.beans.*;
import java.by.bsuir.vt3.server.controller.ServerController;
import java.by.bsuir.vt3.server.service.ServerService;
import java.by.bsuir.vt3.server.service.ServiceFactory;
    ...
    public Response action(Request request) {
        ...
        switch(request.getRequestType()) {
            ...
            case GET: {
                ...
                try {
                    Student student = serverService.get(Integer.parseInt(params[0]));
                    if(student == null) {
                    ...
                    response.setStudents(new Student[] {student});
                    return response;
            ...
            case GET_ALL:{
                ...
                try {
                    ...
                    response.setStudents(students.toArray(new Student[0]));
                    return response;
